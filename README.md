...
URL: 127.0.0.1/users
Controller Name: UserssController
Controller Action: index
View File Name: users.index.html.erb
Layout File Name: layours/application
...
Why do you think this line is there? Because it is needed in order to get the users from the database so that our page will display an accurate account of the users.
